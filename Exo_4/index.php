...
<head>
  ...
  <title>PHP Exo_4 Part_6</title>
</head>
<body>
  <div class="container">
    <div class="row d-flex justify-content-center">
      <div class="col-12">
        <h1 class="text-danger text-center">## Exercice 4 Partie 6</h1>
        <h2>
          Créez un formulaire avec les champs "civilité", "nom" et "prénom".
          À l'envoie du formulaire sur la même page, Affichez les informations saisies. Les champs doivent être
          renseignés.
          Vérifiez la saisie. Empêchez l'affichage de balises html.
        </h2>
    ...
    ?>
      ...
      <div class="row d-flex justify-content-center mt-5">
        <form class="text-center d-flex-column col-6" action="index.php" method="post">
          <div>
      ...
      if(isset($_POST['lastName']) && isset($_POST['firstName']) && isset($_POST['gender'])){
        if(preg_match($reGex, $_POST['lastName']) && preg_match($reGex, $_POST['firstName'])){
          ?>
          <p class="mt-5 text-center">Sexe : <?= $_POST['gender'] ?></p>
